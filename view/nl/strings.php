...
$a->strings["Approved connections"] = "Goedgekeurde connecties";
...
$a->strings["Error: Apache webserver mod-rewrite module is required but not installed."] = "Fout: De Apache-module mod-rewrite is vereist, maar niet geïnstalleerd.";
$a->strings["proc_open"] = "proc_open";
$a->strings["Error: proc_open is required but is either not installed or has been disabled in php.ini"] = "Fout: proc_open is vereist, maar is niet geïnstalleerd of uitgeschakeld in php.ini";
$a->strings["Error: libCURL PHP module required but not installed."] = "Fout: de PHP-module libCURL is vereist, maar niet geïnstalleerd.";
$a->strings["Error: GD graphics PHP module with JPEG support required but not installed."] = "Fout: de PHP-module GD graphics (met JPEG-ondersteuning) is vereist, maar niet geïnstalleerd.";
$a->strings["Error: openssl PHP module required but not installed."] = "Fout: de PHP-module openssl is vereist, maar niet geïnstalleerd.";
$a->strings["Error: mysqli PHP module required but not installed."] = "Fout: de PHP-module mysqli is vereist, maar niet geïnstalleerd.";
$a->strings["Error: mb_string PHP module required but not installed."] = "Fout: de PHP-module mb_string is vereist, maar niet geïnstalleerd.";
$a->strings["Error: mcrypt PHP module required but not installed."] = "Fout: de PHP-module mcrypt is vereist, maar niet geïnstalleerd.";
$a->strings["The web installer needs to be able to create a file called \".htconfig.php\ in the top folder of your web server and it is unable to do so."] = "Der web-installer moet in staat zijn om het bestand \".htconfig.php\" (in de bovenste map van je webserver) aan te maken, maar was daar niet toe in staat.";
