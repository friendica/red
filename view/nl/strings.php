...
$a->strings["Unable to verify channel signature"] = "Kanaal-kenmerk kon niet worden geverifieerd.  ";
$a->strings["Unable to verify site signature for %s"] = "Hub-kenmerk voor %s kon niet worden geverifieerd";
...
$a->strings["Connection has no individual permissions!"] = "Connectie heeft geen individuele rechten!";
...
$a->strings["Could not connect to specified site URL. Possible SSL certificate or DNS issue."] = "Kon geen verbinding maken met de opgegeven hub-URL. Mogelijk een probleem met de SSL-certificaat of DNS.";
$a->strings["Could not create table."] = "Kon geen tabel aanmaken.";
$a->strings["Your site database has been installed."] = "De database voor jouw hub is geïnstalleerd.";
$a->strings["You may need to import the file \"install/database.sql\" manually using phpmyadmin or mysql."] = "Je moet handmatig het bestand  \"install/database.sql\" importeren met behulp van phpmyadmin of mysql.";
$a->strings["Please see the file \"install/INSTALL.txt\"."] = "Zie het bestand ";
$a->strings["System check"] = "Systeemcontrole";
$a->strings["Next"] = "Volgende";
$a->strings["Check again"] = "Controleer opnieuw";
$a->strings["Database connection"] = "Database-verbinding";
...
$a->strings["Please contact your hosting provider or site administrator if you have questions about these settings."] = "Neem contact op met je hostingprovider of serverbeheerder wanneer je vragen hebt over deze instellingen.";
$a->strings["The database you specify below should already exist. If it does not, please create it before continuing."] = "De database die je hier beneden invult moet al bestaan. Wanneer deze nog niet bestaat, moet je die database eerst aanmaken.";
$a->strings["Database Server Name"] = "Servernaam database";
$a->strings["Default is localhost"] = "Standaard is ";
$a->strings["Database Port"] = "Poort database";
$a->strings["Communication port number - use 0 for default"] = "Communicatiepoort - gebruik 0 voor de standaardpoort";
...
$a->strings["Please use SSL (https) URL if available."] = "Gebruik een SSL (https) URL, wanneer deze beschikbaar is.";
$a->strings["Please select a default timezone for your website"] = "Kies een standaard tijdzone voor jouw hub";
$a->strings["Site settings"] = "Hub-instellingen";
$a->strings["Could not find a command line version of PHP in the web server PATH."] = "De command-line-versie van PHP kon niet in het webserver PATH gevonden worden.";
$a->strings["If you don't have a command line version of PHP installed on server, you will not be able to run background polling via cron."] = "Wanneer je niet de command-line-versie van PHP op deze server hebt geïnstalleerd, dan ben je niet in staat om achtergrond-polling via cron uit te voeren.";
$a->strings["PHP executable path"] = "Uitvoerbaar pad PHP";
$a->strings["Enter full path to php executable. You can leave this blank to continue the installation."] = "Geef het volledige pad op naar de PHP-toepassing. Je kan dit leeg laten om met de installatie verder te gaan.";
$a->strings["Command line PHP"] = "Command-line PHP";
$a->strings["The command line version of PHP on your system does not have \"register_argc_argv\" enabled."] = "De command-line-versie van PHP op jouw systeem heeft \"register_argc_argv\" niet ingeschakeld.";
$a->strings["This is required for message delivery to work."] = "Dit is vereist om berichten af te kunnen leveren.";
$a->strings["PHP register_argc_argv"] = "PHP register_argc_argv";
$a->strings["Error: the \"openssl_pkey_new\" function on this system is not able to generate encryption keys"] = "Foutmelding: de functie \"openssl_pkey_new\" op dit systeem is niet in staat om encryptie-sleutels aan te maken";
...
$a->strings["Apache mod_rewrite module"] = "Apache-module mod_rewrite";
$a->strings["Error: Apache webserver mod-rewrite module is required but not installed."] = "Foutmelding: De Apache-module mod-rewrite is vereist, maar niet geïnstalleerd.";
$a->strings["proc_open"] = "proc_open";
$a->strings["Error: proc_open is required but is either not installed or has been disabled in php.ini"] = "Foutmelding: proc_open is vereist, maar is niet geïnstalleerd of uitgeschakeld in php.ini";
$a->strings["Error: libCURL PHP module required but not installed."] = "Foutmelding: de PHP-module libCURL is vereist, maar niet geïnstalleerd.";
$a->strings["Error: GD graphics PHP module with JPEG support required but not installed."] = "Foutmelding: de PHP-module GD graphics (met JPEG-ondersteuning) is vereist, maar niet geïnstalleerd.";
$a->strings["Error: openssl PHP module required but not installed."] = "Foutmelding: de PHP-module openssl is vereist, maar niet geïnstalleerd.";
$a->strings["Error: mysqli PHP module required but not installed."] = "Foutmelding: de PHP-module mysqli is vereist, maar niet geïnstalleerd.";
$a->strings["Error: mb_string PHP module required but not installed."] = "Foutmelding: de PHP-module mb_string is vereist, maar niet geïnstalleerd.";
$a->strings["Error: mcrypt PHP module required but not installed."] = "Foutmelding: de PHP-module mcrypt is vereist, maar niet geïnstalleerd.";
$a->strings["The web installer needs to be able to create a file called \".htconfig.php\ in the top folder of your web server and it is unable to do so."] = "Der web-installer moet in staat zijn om het bestand \".htconfig.php\" (in de bovenste map van je Red Matrix-installatie) aan te maken, maar was daar niet toe in staat.";
$a->strings["This is most often a permission setting, as the web server may not be able to write files in your folder - even if you can."] = "Dit komt meestal door een probleem met de bestandsrechten. De webserver is niet in staat om bestanden te bewerken in de Red Matrix-map. Zorg ervoor dat (bijv.) gebruiker www-data lees- en schrijfrechten heeft in deze en onderliggende mappen.";
$a->strings["At the end of this procedure, we will give you a text to save in a file named .htconfig.php in your Red top folder."] = "Aan het eind van deze installatieprocedure krijg je een tekst die je moet opslaan in een bestand genaamd .htconfig.php in de bovenste map van je Red Matrix-installatie.";
$a->strings["You can alternatively skip this procedure and perform a manual installation. Please see the file \"install/INSTALL.txt\" for instructions."] = "Je kan ook deze installatieprocedure overslaan en een handmatige installatie uitvoeren. Zie het bestand \"install/INSTALL.txt\" voor instructies.";
$a->strings[".htconfig.php is writable"] = ".htconfig.php is beschrijfbaar";
$a->strings["Red uses the Smarty3 template engine to render its web views. Smarty3 compiles templates to PHP to speed up rendering."] = "De Red Matrix gebruikt de Smarty3 template engine om webpagina's te genereren. Smarty3 compileert templates naar PHP om het genereren te versnellen.";
$a->strings["In order to store these compiled templates, the web server needs to have write access to the directory view/tpl/smarty3/ under the Red top level folder."] = "Om deze gecompileerde templates te kunnen opslaan, dient de webserver schrijfrechten te hebben in de map view/tpl/smarty3/ (in de Red Matrix-installatie).";
$a->strings["Please ensure that the user that your web server runs as (e.g. www-data) has write access to this folder."] = "Zorg er voor dat de gebruiker waaronder jouw webserver draait (bijv. www-data) schrijfrechten heeft in deze map.";
$a->strings["Note: as a security measure, you should give the web server write access to view/tpl/smarty3/ only--not the template files (.tpl) that it contains."] = "Opmerking: voor de veiligheid adviseren we je alleen schrijfrechten aan je webserver te geven voor de map view/tpl/smarty3/. Dus niet aan de template-bestanden (.tpl) die zich daar in bevinden.";
$a->strings["view/tpl/smarty3 is writable"] = "view/tpl/smarty3 is beschrijfbaar";
...
$a->strings["SSL certificate cannot be validated. Fix certificate or disable https access to this site."] = "De SSL-certificaat kon niet gevalideerd worden. Repareer de certificaat of schakel de https-toegang voor deze hub uit.";
...
$a->strings["SSL certificate validation"] = "SSL-certificaatvalidatie ";
$a->strings["Url rewrite in .htaccess is not working. Check your server configuration."] = "URL-rewrite in  .htaccess werkt niet. Controleer jouw serverconfiguratie.";
$a->strings["Url rewrite is working"] = "UTL-rewrite werkt";
...
$a->strings["Send invitations"] = "Uitnodiginen verzonden";
...
$a->strings["Schema Default"] = "Standaard-schema";
...
$a->strings["Header image only on profile pages"] = "Header-afbeelding alleen op profielpagina weergeven";
...
$a->strings["Are you sure you want to delete this item?"] = "Weet je zeker dat je dit item wil verwijderen?";
