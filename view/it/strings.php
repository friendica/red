...
$a->strings["Enhanced Photo Albums"] = "Album fotografici avanzati";
$a->strings["Enable photo album with enhanced features"] = "Abilita gli album fotografici con funzionalità avanzate";
...
$a->strings["Allow encryption of content end-to-end with a shared secret key"] = "Abilita la crittografia dei contenuti tra il mittente e i destinatari con una chiave segreta";
...
$a->strings["Requires compatible chat plugin"] = "Necessita di un plugin di chat compatibile";
...
$a->strings["This channel publishes adult content."] = "Questo canale pubblica contenuto per adulti.";
$a->strings["Security and Privacy Settings"] = "Impostazioni di sicurezza e privacy";
$a->strings["Quick Privacy Settings:"] = "Impostazioni veloci della privacy:";
$a->strings["Very Public - extremely permissive"] = "Tutto pubblico - molto permissivo";
$a->strings["Typical - default public, privacy when desired"] = "Normale - tutto sarà pubblico tranne quel che vorrai tu";
$a->strings["Private - default private, rarely open or public"] = "Privato - i contenuti saranno privati ma, se vorrai, alcuni potrai renderli pubblici";
$a->strings["Blocked - default blocked to/from everybody"] = "Bloccato - non ci saranno interazioni con altri a meno che tu non voglia";
...
$a->strings["Friend Request URL"] = "URL di richiesta amicizia";
$a->strings["Friend Confirm URL"] = "URL di conferma amicizia";
...
$a->strings["Introductions"] = "Richieste di amicizia";
$a->strings["Show Ignored Requests"] = "Mostra le richieste ignorate";
$a->strings["Hide Ignored Requests"] = "Nascondi le richieste ignorate";
$a->strings["Notification type: "] = "Tipo di notifica: ";
$a->strings["Friend Suggestion"] = "Suggerimento di amicizia";
...
$a->strings["%s disliked %s's post"] = "A %s non è piaciuto l'articolo di %s";
$a->strings["%s is now friends with %s"] = "%s è ora amico di %s";
$a->strings["%s created a new post"] = "%s ha creato un nuovo articolo";
$a->strings["%s commented on %s's post"] = "%s ha commentato l'articolo di %s";
$a->strings["No more network notifications."] = "Non ci sono nuove notifiche dalla rete.";
...
$a->strings["No more personal notifications."] = "Non ci sono nuove notifiche personali.";
$a->strings["Personal Notifications"] = "Notifiche personali";
$a->strings["No more home notifications."] = "Non ci sono nuove notifiche dalla bacheca.";
$a->strings["Home Notifications"] = "Notifiche dalla bacheca";
...
$a->strings["Suggestions, praise, donations, etc. - please email \"redmatrix\" at librelist - dot com"] = "Per consigli, ringraziamenti, donazioni, ecc. - scrivi a \"redmatrix\" at librelist - dot com";
