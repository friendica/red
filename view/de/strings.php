...
$a->strings["[+] show all"] = "[+] alles anzeigen";
...
$a->strings["Disable discovery tab"] = "Schalte den Entdecken Reiter aus";
...
$a->strings["Schema Default"] = "Schema-Default";
...
$a->strings["Set iconset"] = "Icon-Sammlung";
$a->strings["Set big shadow size, default 15px 15px 15px"] = "Größe der großen Schatten, Default 15px 15px 15px";
$a->strings["Set small shadow size, default 5px 5px 5px"] = "Größe der kleinen Schatten, Default 5px 5px 5px";
$a->strings["Set shadow color, default #000"] = "Farbe der Schatten, Default #000";
$a->strings["Set radius size, default 5px"] = "Radius, Default 5px";
$a->strings["Set line-height for posts and comments"] = "Zeilenabstand für Beiträge und Kommentare";
$a->strings["Set background image"] = "Hintergrundbild";
$a->strings["Set background attachment"] = "Anhang für den Hintergrund";
...
$a->strings["Set max-width for items.  Default 400px"] = "max-width für Beiträge, Default 400px";
$a->strings["Set min-width for items.  Default 240px"] = "min-width für Beiträge, Default 240px";
...
$a->strings["Display post previews only"] = "Nur Vorschauen für Posts anzeigen";
$a->strings["Display side bar on channel page"] = "Seitenleiste auf der Kanal-Seite anzeigen";
...
$a->strings["None"] = "Keiner";
$a->strings["Header image"] = "Bild für die Kopfzeile";
$a->strings["Header image only on profile pages"] = "Kopfzeile nur auf Profilseiten";
